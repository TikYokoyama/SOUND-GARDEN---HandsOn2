...
const loadEvent = async () => {
    const params = new URLSearchParams(window.location.search);  //busca por parametro na propria URL (id)
    ...
    inputData.value = date.toLocaleDateString('pt-BR') + ' ' + (date.toLocaleTimeString('pt-BR')).substring(0, 5)  //00/00/00 23:23
